    ...
    >
      <ThemedView style={styles.container}>
        <ThemedView style={styles.titleContainer}>
          ...
          <ExternalLink href="http://docs.expo.dev" asChild>
        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="File-based routing">
            ...
            <ExternalLink href="http://docs.expo.dev/router/introduction">
          ...
          <Collapsible title="Images">
            ...
            />
            <ExternalLink href="http://reactnative.dev/docs/images">
              <ThemedText type="linkPrimary">Learn more</ThemedText>
            </ExternalLink>
          </Collapsible>
          ...
          <Collapsible title="Light and dark mode components">
            ...
            <ExternalLink href="http://docs.expo.dev/develop/user-interface/color-themes/">
              <ThemedText type="linkPrimary">Learn more</ThemedText>
            </ExternalLink>
          </Collapsible>
